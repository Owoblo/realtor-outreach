...
Output:
  output/wkg/envelopes/ENVELOPES_TIER1.pdf
  output/wkg/envelopes/ENVELOPES_ALL.pdf
"""
...
RET_LINE1 = "55 Cedar Drive"
RET_LINE2 = "Guelph, ON  N1G 1C4"
PHONE     = "(226) 773-2993"
...
def main():
    if not AGENT_CSV.exists():
        print("ERROR: agent_summary.csv not found. Run generate_letters_wkg.py first.")
        return
